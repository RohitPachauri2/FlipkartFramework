...
public class Reusablefunctions extends libarrayclass {
...
// wait for visiblity
	...
	public void waitForSearchResults() {
		new WebDriverWait(driver, Duration.ofSeconds(10))
				.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("._1YokD2 ._1AtVbE")) // Adjust
																											// based on
																											// result
																											// section
				);
	...
	public void attachscreenshotwithextentreports(Scenario scenario) {
	    final byte[] screenshot = ((TakesScreenshot) driver).getScreenshotAs(OutputType.BYTES);
	    scenario.attach(screenshot, "image/png","flipkartapplication");  // Attach screenshot to the report
	}
